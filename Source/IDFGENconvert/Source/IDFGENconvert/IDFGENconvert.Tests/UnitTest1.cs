...
using Sweco.SIF.IDFGENconvert.Tests;

namespace Sweco.SIF.IDFGENconvert.Tests.Tests
{
    [TestClass]
    public class UnitTest1 : UnitTestBase
    {
        ...
        {
            string options = "/h:1";
            string inputPath = @"..\..\..\..\..\..\..\IDFGENconvert\Test\Input";
            string inputFilter = @"25JZONE_25X25.IDF";
        ...
        {
            string options = "/g:25,4"; 
            string inputPath = @"..\..\..\..\..\..\Test\Input";
            string inputFilter = "RIV.GEN";
            string outputPath = @"..\..\..\..\..\..\Test\Output";
            string commandLine = options + " " + inputPath + " " + inputFilter + " " + outputPath;
            string[] args = CommonUtils.CommandLineToArgs(commandLine);
            SIFToolSettings settings = new SIFToolSettings(args);
