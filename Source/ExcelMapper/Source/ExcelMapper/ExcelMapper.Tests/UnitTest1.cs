...
using Sweco.SIF.ExcelMapper.Tests;

namespace Sweco.SIF.ExcelMapper.Tests.Tests
{
    [TestClass]
    public class UnitTest1 : UnitTestBase
    {
        ...
        {
            string insertStringFilename = @"..\..\..\..\..\..\Test\Input\REGIS-test\ExcelMapper consistencycheck_insertstring.TXT";
            string baseStringFilename = @"..\..\..\..\..\..\Test\Input\REGIS-test\ExcelMapper consistencycheck_basestring.TXT";
            string inputExcelFilename = @"..\..\..\..\..\..\Test\Input\REGIS-test\REGIS-table.xlsx";
            string outputFilename = @"..\..\..\..\..\..\Test\Output\REGIS-test\IDFexp consistencycheck.INI";
            string commandLine = "/s:1 /r:5 /i:\"" + insertStringFilename + "\" \"" + inputExcelFilename + "\" \"" + baseStringFilename + "\" \"" + outputFilename + "\"";
