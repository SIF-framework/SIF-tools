...
{
    /// <summary>
    /// Class for managing Excel spreadsheet files with EPPlus-library
    /// </summary>
    public class EPPlusExcelManager : ExcelManager
    {
        public EPPlusExcelManager()
        {
        }
        ...
        {
            return EPPlusWorkbook.OpenWorkbook(filename, isReadOnly);
        }
        ...
        public override IWorkbook CreateWorkbook(bool isEmptySheetAdded = true, string sheetname = null)
        {
            ...
            EPPlusWorkbook workbook = new EPPlusWorkbook(excelPackage, null);
            if (isEmptySheetAdded)
            {
