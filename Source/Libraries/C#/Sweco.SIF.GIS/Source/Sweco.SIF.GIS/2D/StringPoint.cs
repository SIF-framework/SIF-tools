...
namespace Sweco.SIF.GIS
{
    ...
    /// </summary>
    public class StringPoint : Point
    {
        /// <summary>
        ...
        /// <summary>
        /// Constructor for StringPoint object with x, y-coordinates defined as floating point values
        /// </summary>
        /// <param name="x"></param>
        /// <param name="y"></param>
        ...
        /// <summary>
        /// Constructor for StringPoint object with x, y-coordinates defined as strings. Coordinate strings should be in english notation (decimalseperator is a point)
        /// </summary>
        /// <param name="xString"></param>
        /// <param name="yString"></param>
        public StringPoint(string xString, string yString)
        {
            Initialize(xString, yString);
        }

        /// <summary>
        /// Retrieve HashCode for this object based on hashcodes of xy-strings
        /// </summary>
        /// <returns></returns>
        public override int GetHashCode()
        {
            return xString.GetHashCode() ^ yString.GetHashCode();
        }

        /// <summary>
        /// Creates a copy of this StringPoint object
        /// </summary>
        /// <returns></returns>
