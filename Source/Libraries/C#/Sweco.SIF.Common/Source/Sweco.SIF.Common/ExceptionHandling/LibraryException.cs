...
namespace Sweco.SIF.Common.ExceptionHandling
{
    /// <summary>
    /// Exception subclass that is dedicated to expected exceptions/messages from SwecoTools for which only 
    /// </summary>
    public class LibraryException : Exception
    {
        /// <summary>
        /// LibraryException for expected error messages 
        /// </summary>
        ...
        /// <param name="message"></param>
        /// <param name="ex"></param>
        public LibraryException(string message, Exception ex) : base(message, ex)
        {
        }
    }
}
