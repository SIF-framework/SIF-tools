...
{
    public class REGISVersionFactory
    {
        public static REGISVersion RetrieveVersion(string filename)
        {
            // For now always return REGISIIVersion
            return new REGISIIVersion();
        }
    }
}
