...
{
    public abstract class REGISVersion
    {
        public abstract string CorrectLayerLevelName(string filename);

        public abstract string GetTOPFilename(string botFilename);

        public abstract string GetBOTFilename(string topFilename);
    }
}
