...
{
    /// <summary>
    ///  Class for storing general parameters of IMFcreate INI-file
    /// </summary>
    public class INIParameters
    {
        public string INIPath { get; set; } = string.Empty;
        public string IMODPath { get; set; } = string.Empty;
        public bool IsIMODopened { get; set; } = false;
        public bool IsAddOnce { get; set; } = false;
        public string IMFFilename { get; set; }
