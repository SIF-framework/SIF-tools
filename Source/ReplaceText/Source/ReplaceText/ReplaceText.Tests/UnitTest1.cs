...
using Sweco.SIF.ReplaceText.Tests;

namespace Sweco.SIF.ReplaceText.Tests.Tests
{
    [TestClass]
    public class UnitTest1 : UnitTestBase
    {
        ...
        {
            string sourceFilename = @"..\..\..\..\..\..\Test\Input\meetreeksen_stat_l1.ipf";
            string testPath = @"..\..\..\..\..\..\Test\Output";
            string testFilename = Path.Combine(testPath, Path.GetFileName(sourceFilename));
            Assert.IsTrue(File.Exists(sourceFilename));
            File.Copy(sourceFilename, testFilename, true);

            string commandLine = "/d /x /m  \"\" " + testFilename + " @\",(\\r\\n|\\n)\" @\"\\r\\n\"";
            string[] args = CommonUtils.CommandLineToArgs(commandLine);
            SIFToolSettings settings = new SIFToolSettings(args);
            SIFTool sifTool = new SIFTool(settings);
            Console.WriteLine("Testing " + GetToolName() + " with arguments: " + CommonUtils.ToString(new List<string>(settings.Args), " "));
