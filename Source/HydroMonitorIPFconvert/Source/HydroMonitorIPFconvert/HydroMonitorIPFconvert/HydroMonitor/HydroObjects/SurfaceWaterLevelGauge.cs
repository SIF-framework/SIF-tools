...
{
    /// <summary>
    /// Subclass of TimerseriesHydroObject for storing surface water levels
    /// </summary>
    public class SurfaceWaterLevelGauge : TimeseriesHydroObject
    {
        public SurfaceWaterLevelGauge(HydroMonitorFile hydroMonitorFile, string id) : base(hydroMonitorFile, id)
        {
            Type = HydroObjectType.SurfaceWaterLevelGauge;
        }
    }
}
