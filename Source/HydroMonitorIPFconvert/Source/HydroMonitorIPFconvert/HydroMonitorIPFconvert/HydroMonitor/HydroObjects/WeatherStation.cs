...
{
    /// <summary>
    /// Subclass of TimerseriesHydroObject for storing weatherstation data
    /// </summary>
    public class WeatherStation : TimeseriesHydroObject
    {
        public WeatherStation(HydroMonitorFile hydroMonitorFile, string id) : base(hydroMonitorFile, id)
        {
            Type = HydroObjectType.WeatherStation;
        }
    }
}
