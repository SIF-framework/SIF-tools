...
{
    /// <summary>
    /// Subclass of TimerseriesHydroObject for storing pumping  wells
    /// </summary>
    public class PumpingWell : TimeseriesHydroObject
    {
        public PumpingWell(HydroMonitorFile hydroMonitorFile, string id) : base(hydroMonitorFile, id)
        {
            Type = HydroObjectType.PumpingWell;
        }
    }
}
