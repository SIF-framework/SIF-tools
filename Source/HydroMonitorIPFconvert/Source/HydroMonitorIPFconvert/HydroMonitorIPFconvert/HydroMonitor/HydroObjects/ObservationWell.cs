...
{
    /// <summary>
    /// Subclass of TimerseriesHydroObject for storing observation wells
    /// </summary>
    public class ObservationWell : TimeseriesHydroObject
    {
        public ObservationWell(HydroMonitorFile hydroMonitorFile, string id) : base(hydroMonitorFile, id)
        {
            Type = HydroObjectType.ObservationWell;
        }
    }
}
