...
using Sweco.SIF.iMODValidator.Tests;

namespace Sweco.SIF.iMODValidator.Tests.Tests
{
    [TestClass]
    public class UnitTest1 : UnitTestBase
    {
        ...
        {
            string commandLine = "/s:..\\..\\..\\..\\..\\..\\Test\\Input\\iMODValidator.xml ..\\..\\..\\..\\..\\..\\Test\\Input\\RUNFILES\\ORG\\ZUTPHEN_STAT_ORG_BAS.RUN ..\\..\\..\\..\\..\\..\\Test\\Output";
            string[] args = CommonUtils.CommandLineToArgs(commandLine);
            SIFToolSettings settings = new SIFToolSettings(args);
            SIFTool sifTool = new SIFTool(settings);
            Console.WriteLine("Testing " + GetToolName() + " with arguments: " + CommonUtils.ToString(new List<string>(settings.Args), " "));
