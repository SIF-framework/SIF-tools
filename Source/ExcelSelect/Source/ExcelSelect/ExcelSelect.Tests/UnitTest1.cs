...
using Sweco.SIF.ExcelSelect.Tests;

namespace Sweco.SIF.ExcelSelect.Tests.Tests
{
    [TestClass]
    public class UnitTest1 : UnitTestBase
    {
        ...
        {
            string options = "/s:2";
            string inputPath = @"..\..\..\..\..\..\Test\Input\TestSheet.xlsx";
            string outputPath = @"..\..\..\..\..\..\Test\Output\TestSheetCorr.xlsx";
        ...
        {
            string options = "/r:2 /f:2,\"TestFiles\",GEN ";
            string inputPath = @"..\..\..\..\..\..\Test\Input\TestSheet.xlsx";
            string outputPath = @"..\..\..\..\..\..\Test\Output\TestSheetCorr.xlsx";
            string commandLine = options + " " + inputPath + " " + outputPath;
            string[] args = CommonUtils.CommandLineToArgs(commandLine);
